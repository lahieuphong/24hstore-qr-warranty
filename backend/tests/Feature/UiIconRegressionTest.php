...
class UiIconRegressionTest extends TestCase
{
    ...
    public function test_backend_blade_views_only_use_lucide_components_for_inline_ui_icons(): void
    {
        $violations = [];
        ...
        $this->assertTrue($hasLucideComponent, 'No Lucide Blade component was found in backend views.');
        $this->assertSame([], $violations, "Backend Blade icon regressions:\n".implode("\n", $violations));
    }
